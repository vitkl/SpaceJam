...
<body>
	...
	<div id = 'instructionBoard'>
		...
		<div>
			...
			<div id = 'instructions_div'><ul>
				...
				<li>The "Gene / celltype selection menu" contains functionalities for editing the list of genes that are plotted</li>
				<li>The "Add new gene or celltype" adds a randomly chosen gene to the list. The plots are redraw to include the additional gene</li>
    ...
    <mark>Categorical variable</mark> <select id = "cat_var" name = "variable" onchange= "this.form.submit()">
...
<?php
    if(isset($_GET["variable"])){
        ...
        $variable = "celltype_abundance_region_cond.txt";
        $data_var = file_get_contents('./main/'.$variable, FILE_USE_INCLUDE_PATH);
        
    }
    ?>
    </select>
<label for="cat_var"><mark>Variable selected: "<?php echo $variable?>"</mark>
</label>
    </form>
    </div>
	...
	<div class = 'menuContainer'><div><b>Gene selection menu</b></div><hr>
		<input type = 'button' value = 'Add new gene or celltype' onclick = 'generateNewGeneButton()'/>
	...
	<script type = 'text/javascript'>
		...
		window.onload = function(){
			...
			for (i=0; i < 33; i++){generateNewGeneButton()}
	...
	<div style="float: clear;""><hr><span style="font-size:0.8em;">This data portal was created using the interactive_heatmap_dotplot tool (<a href="https://https://github.com/haniffalab/FCA_bone_marrow/tree/master/pipeline_scripts/pipeline_interactive_heatmap_dotplot">github link</a>) developed by Issac Goh, maintained by Issac Goh</span><hr></div>
</body>
</html>
