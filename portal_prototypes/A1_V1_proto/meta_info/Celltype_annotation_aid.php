...
<html>
<head>
<title>Script which reads CSV files and converts to HTML table using AJAX jQuery</title>
...
<?php
    ...
    foreach($DRs as $DR){
        ...
        if (($DR !== '.') && ($DR !=='..') && ($DR !=='categories') && ($DR !=='main')) {
    ?>
